...
pgfault 2301445
\end{verbatim}
\item The /proc filesystem is not persistent storage in the same sense as an NTFS or ext3 filesystem, so don't bother searching for file I/O tutorials. From \url{http://www.tldp.org/LDP/Linux-Filesystem-Hierarchy/html/proc.html}:
